...
function Gallery() {
  ...
  useEffect(() => {
    const fetchBooks = () => {
      const mockData = [ // por mientras
        { id: 1, title: "Libro 1", price: 25000, img: "https://via.placeholder.com/150" },
        { id: 2, title: "Libro 2", price: 15000, img: "https://via.placeholder.com/150" },
        { id: 3, title: "Libro 3", price: 32000, img: "https://via.placeholder.com/150" },
        { id: 4, title: "Libro 4", price: 18000, img: "https://via.placeholder.com/150" },
        { id: 5, title: "Libro 5", price: 21000, img: "https://via.placeholder.com/150" }
      ];
  ...
  const handleAddToCart = (book) => {
    if (!user) {
      ...
      console.log(`Añadiendo "${book.title}" al carrito del usuario ${user.name}`);
